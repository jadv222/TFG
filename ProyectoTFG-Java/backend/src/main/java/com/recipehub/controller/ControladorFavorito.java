...
import com.recipehub.service.ServicioFavorito;
...
public class ControladorFavorito {
    ...
    @Autowired
    private ServicioFavorito favoriteService;
    ...
    public ResponseEntity<?> obtenerFavoritos(HttpServletRequest request) {
        try {
            ...
            List<Favorito> favoritos = favoriteService.obtenerFavoritos(usuarioId);
    ...
    public ResponseEntity<?> guardarFavorito(
        ...
        try {
            ...
            Favorito favorito = favoriteService.guardarFavorito(
                usuarioId,
